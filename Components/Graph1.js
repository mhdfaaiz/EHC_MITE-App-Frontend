...
export default function Graph({ dataA = [], dataB = []}) {
    ...
    const exactDataA = safeMap(dataA);
    const exactDataB = safeMap(dataB);
            ...
            <View>
                ...
                <LineChart
                    data={{
                        labels: labels,
                        datasets: [
                            { data: exactDataA, color: (opacity = 1) => `rgba(134, 65, 244, ${opacity})`, strokeWidth: 2 }, // A
                            { data: exactDataB, color: (opacity = 1) => `rgba(244, 67, 54, ${opacity})`, strokeWidth: 2 }, // B
                        ],
                    }}
