...
const IndicatorApp = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const socket = io("http://10.255.254.24:3000");
        ...
        socket.on('alarm', (data) => {
            ...
            if (data.serialno === serialNumber) {
                ...
                fetch('http://10.255.254.24:3000/api/indicatoricons/update', {
                    method: 'POST',
    ...
    useEffect(() => {
        const initializeIndicators = async () => {
            try {
                await fetch('http://10.255.254.24:3000/api/initialize', {
                    method: 'POST',
                    headers: {
    ...
    useEffect(() => {
        const fetchIndicators = async () => {
            try {
                const response = await fetch(`http://10.255.254.24:3000/api/indicators/${serialNumber}`);
    ...
    useEffect(() => {
        const fetchIndicatorColors = async () => {
            try {
                const response = await fetch(`http://10.255.254.24:3000/api/indicatoricons/${serialNumber}`);
                const data = await response.json();
    ...
    const fetchLogs = async () => {
        try {
            const response = await fetch("http://10.255.254.24:3000/api/logs"); // Replace with your API URL
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://10.255.254.24:3000/api/mqtt-data');
                await response.json();
            } catch (error) {
    ...
    useEffect(() => {
        const fetchReverseIndicator = async () => {
            try {
                const response = await fetch(`http://10.255.254.24:3000/api/reverse-indicator/${serialNumber}`);
                const data = await response.json();
